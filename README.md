...
- Avoid using the API in a meta tag on your website, as this will regenerate the OG image for every visitor.  
- Instead, create an API endpoint and cache the generated images to prevent redundant image generation (and unnecessary costs).  
